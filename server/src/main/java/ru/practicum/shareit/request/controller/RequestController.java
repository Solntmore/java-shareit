...
public class RequestController {
    ...
    @PostMapping
    public ResponseRequestDto createItemRequest(@RequestHeader(Constants.X_SHADER_USER_ID) long userId,
    ...
    @GetMapping
    public List<ResponseRequestDto> getMyItemsRequest(@RequestHeader(Constants.X_SHADER_USER_ID) long userId) {
    ...
    @GetMapping("/all")
    public List<ResponseRequestDto> getInfoOfRequest(@RequestHeader(Constants.X_SHADER_USER_ID) long userId,
        ...
        return requestService.getInfoOfRequest(userId, Convert.toPageRequest(from, size));
    }

    @GetMapping("/{requestId}")
    public ResponseRequestDto getInformationAboutOneRequest(@RequestHeader(Constants.X_SHADER_USER_ID) long userId,
